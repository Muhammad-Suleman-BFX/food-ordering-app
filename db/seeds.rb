...
CartItem.create!(cart: cart1, branch_menu_item: cart1_bmi3, branch_menu_item_quantity: 1)
...
CartItem.create!(cart: cart2, branch_menu_item: cart2_bmi1, branch_menu_item_quantity: 1)
...
CartItem.create!(cart: cart3, branch_menu_item: cart3_bmi1, branch_menu_item_quantity: 2)
...
CartItem.create!(cart: cart3, branch_menu_item: cart3_bmi3, branch_menu_item_quantity: 1)
